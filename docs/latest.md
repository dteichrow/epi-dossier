...
- Category mix: Outbreaks and emerging infections (199), Policy, surveillance, and public health infrastructure (32), Occupational and environmental epidemiology (11)
...
## Major topics
### Measles transmission and vaccination
- Topic size: 99 item(s) across 75 source(s); 1 official/primary-source item(s).
...
### Ebola virus disease
- Topic size: 65 item(s) across 50 source(s); 4 official/primary-source item(s).
