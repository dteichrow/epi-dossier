...
- New publisher/source coverage joined this story cluster: CIDRAP.
...
- New publisher/source coverage joined this story cluster: Rural Radio Network.
- Story volume increased from 15 to 17 clustered item(s) in the current window.
- 2 newly observed linked item(s) were added since the last saved snapshot.
...
- New publisher/source coverage joined this story cluster: CIDRAP, Contagion Live, ReliefWeb.
- The lead item has changed to [Ebola outbreak in DR Congo still outpacing response](https://www.cidrap.umn.edu/ebola/ebola-outbreak-dr-congo-still-outpacing-response) from CIDRAP.
