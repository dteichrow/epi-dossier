...
- Newly tracked story cluster: 110 item(s) across 66 source(s).
- Baseline snapshot created with 110 clustered item(s) across 66 source(s).
...
## Major topics
### Ebola virus disease
- Topic size: 110 item(s) across 66 source(s); 3 official/primary-source item(s).
