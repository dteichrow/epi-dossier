...
- Category mix: Outbreaks and emerging infections (240), Policy, surveillance, and public health infrastructure (15), Occupational and environmental epidemiology (2)
...
- Newly tracked story cluster: 116 item(s) across 98 source(s).
...
- Newly tracked story cluster: 63 item(s) across 51 source(s).
...
## Major topics
### Measles transmission and vaccination
- Topic size: 116 item(s) across 98 source(s); 1 official/primary-source item(s).
...
### Ebola virus disease
- Topic size: 63 item(s) across 51 source(s); 2 official/primary-source item(s).
...
- Topic size: 27 item(s) across 23 source(s); 1 official/primary-source item(s).
