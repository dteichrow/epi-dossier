...
- Category mix: Outbreaks and emerging infections (155), Policy, surveillance, and public health infrastructure (20), Virology and pathogen evolution (2)
...
## Major topics
### Ebola virus disease
- Topic size: 118 item(s) across 86 source(s); 5 official/primary-source item(s).
...
### Measles transmission and vaccination
- Topic size: 26 item(s) across 26 source(s); 2 official/primary-source item(s).
