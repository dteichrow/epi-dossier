...
- Category mix: Outbreaks and emerging infections (54), Policy, surveillance, and public health infrastructure (3)
...
- Topic size: 48 item(s) across 24 source(s); 3 official/primary-source item(s).
