...
- Category mix: Outbreaks and emerging infections (120), Policy, surveillance, and public health infrastructure (6), Major epidemiology studies (4)
...
## Major topics
### Ebola virus disease
- Topic size: 113 item(s) across 74 source(s); 3 official/primary-source item(s).
