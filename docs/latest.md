...
- Category mix: Outbreaks and emerging infections (214), Policy, surveillance, and public health infrastructure (31), Major epidemiology studies (3)
...
## Major topics
### Ebola virus disease
- Topic size: 235 item(s) across 123 source(s); 5 official/primary-source item(s).
