...
- Category mix: Outbreaks and emerging infections (154), Policy, surveillance, and public health infrastructure (21), Major epidemiology studies (2)
...
### Hantavirus and cruise-ship outbreak
- Topic size: 30 item(s) across 28 source(s); 2 official/primary-source item(s).
