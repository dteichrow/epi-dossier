...
- Category mix: Outbreaks and emerging infections (25), Major epidemiology studies (3), Occupational and environmental epidemiology (2)
...
### Hantavirus and cruise-ship outbreak
- Topic size: 16 item(s) across 10 source(s); 0 official/primary-source item(s).
