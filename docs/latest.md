...
- Newly tracked story cluster: 223 item(s) across 136 source(s).
- Baseline snapshot created with 223 clustered item(s) across 136 source(s).
...
## Major topics
### Ebola virus disease
- Topic size: 223 item(s) across 136 source(s); 4 official/primary-source item(s).
