...
- Newly tracked story cluster: 127 item(s) across 103 source(s).
- Baseline snapshot created with 127 clustered item(s) across 103 source(s).
...
## Major topics
### Ebola virus disease
- Topic size: 127 item(s) across 103 source(s); 4 official/primary-source item(s).
