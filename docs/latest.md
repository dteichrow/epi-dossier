...
- Category mix: Outbreaks and emerging infections (219), Policy, surveillance, and public health infrastructure (30), Historical epidemiology / ancient disease / paleopathology (3)
...
## Major topics
### Measles transmission and vaccination
- Topic size: 114 item(s) across 92 source(s); 1 official/primary-source item(s).
...
### Ebola virus disease
- Topic size: 77 item(s) across 64 source(s); 5 official/primary-source item(s).
