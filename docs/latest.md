...
## Major topics
### Ebola virus disease
- Topic size: 115 item(s) across 88 source(s); 3 official/primary-source item(s).
...
- Detailed note: Authorities are especially concerned about Sabah state, where cases have surged by 50.4% to 2,866, up from 1,905 during the same period in 2024. dollar closes lower on Taipei forex market Taiwan's Chen Wei-chung places 1st in int'l conducting competition Taiwan shares close up 2.78% Braves beat Pilots 87-78, take 3-2 lead in PLG Finals Taiex soars to end above 45,000 points on U.S.-Iran peace deal U.S. M alaysia...
