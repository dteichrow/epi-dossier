...
- Newly tracked story cluster: 155 item(s) across 107 source(s).
- Baseline snapshot created with 155 clustered item(s) across 107 source(s).
...
## Major topics
### Ebola virus disease
- Topic size: 155 item(s) across 107 source(s); 3 official/primary-source item(s).
