...
- Category mix: Outbreaks and emerging infections (154), Policy, surveillance, and public health infrastructure (15), Major epidemiology studies (3)
...
## Major topics
### Ebola virus disease
- Topic size: 127 item(s) across 91 source(s); 5 official/primary-source item(s).
