...
- Category mix: Outbreaks and emerging infections (162), Policy, surveillance, and public health infrastructure (16), Historical epidemiology / ancient disease / paleopathology (2)
...
- Baseline snapshot created with 136 clustered item(s) across 106 source(s).
...
## Major topics
### Ebola virus disease
- Topic size: 136 item(s) across 106 source(s); 4 official/primary-source item(s).
