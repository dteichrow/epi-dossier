...
- Category mix: Outbreaks and emerging infections (126), Policy, surveillance, and public health infrastructure (27), Major epidemiology studies (3)
...
### Hantavirus and cruise-ship outbreak
- Topic size: 15 item(s) across 14 source(s); 3 official/primary-source item(s).
