...
- Category mix: Outbreaks and emerging infections (124), Policy, surveillance, and public health infrastructure (7), Occupational and environmental epidemiology (6)
...
## Major topics
### Ebola virus disease
- Topic size: 120 item(s) across 89 source(s); 3 official/primary-source item(s).
...
- [Ebola Outbreak Escalates in Congo: 710 Confirmed Cases](https://www.devdiscourse.com/article/health/3934761-ebola-outbreak-escalates-in-congo-710-confirmed-cases) | Devdiscourse | 2026-06-14T00:02+00:00 | Outbreaks and emerging infections
  Limited detail was available from feed metadata alone.
- [Israel Border Lockdown Triggers African Travel Chaos: Ebola Outbreak Sparks Severe Airport Disruptions and Flight Cancellations](https://www.nomadlawyer.org/israel-ebola-border-lockdown-travel-chaos-2026) | Nomad Lawyer | 2026-06-13T23:34+00:00 | Outbreaks and emerging infections
  In a desperate bid to mitigate domestic viral importation hazards stemming from a highly lethal Bundibugyo ebolavirus epidemic, Israel’s Population and Immigration Authority has temporarily suspended entry privileges for non-citizens originating from seven high-risk African nations. This specific biological variant presents immense diagnostic challenges because mainstream therapeutic vaccines were originally engineered to counteract the vastly different Zaire strain exclusively. Epidemiological tracking groups have recently confirmed over one thousand active infections, alongside mounting mortality numbers, across the African continent.
