...
- Category mix: Outbreaks and emerging infections (146), Policy, surveillance, and public health infrastructure (8), Occupational and environmental epidemiology (4)
...
- Newly tracked story cluster: 108 item(s) across 65 source(s).
- Baseline snapshot created with 108 clustered item(s) across 65 source(s).
...
## Major topics
### Ebola virus disease
- Topic size: 108 item(s) across 65 source(s); 2 official/primary-source item(s).
