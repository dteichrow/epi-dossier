...
- Category mix: Outbreaks and emerging infections (243), Policy, surveillance, and public health infrastructure (45), Historical epidemiology / ancient disease / paleopathology (5)
...
## Major topics
### Cyclosporiasis
- Topic size: 160 item(s) across 106 source(s); 3 official/primary-source item(s).
...
### Ebola virus disease
- Topic size: 113 item(s) across 82 source(s); 4 official/primary-source item(s).
