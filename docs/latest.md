...
- Newly tracked story cluster: 113 item(s) across 69 source(s).
- Baseline snapshot created with 113 clustered item(s) across 69 source(s).
...
## Major topics
### Ebola virus disease
- Topic size: 113 item(s) across 69 source(s); 3 official/primary-source item(s).
...
- Detailed note: Health officials in Lamu County have reported a cholera outbreak that has resulted in two deaths and affected 50 residents. Latest Stories Apple introduces new privacy warning for AI features using Google Cloud: What iPhone users in Kenya need to know Consumers face tighter gas supply, higher price risks through 2027 – report IEBC explains online voter verification outage, assures in-person voter registration...
