...
- Category mix: Outbreaks and emerging infections (209), Policy, surveillance, and public health infrastructure (32), Occupational and environmental epidemiology (12)
...
## Major topics
### Measles transmission and vaccination
- Topic size: 112 item(s) across 83 source(s); 1 official/primary-source item(s).
...
### Ebola virus disease
- Topic size: 63 item(s) across 51 source(s); 4 official/primary-source item(s).
