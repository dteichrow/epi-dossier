...
- Category mix: Outbreaks and emerging infections (213), Policy, surveillance, and public health infrastructure (28), Occupational and environmental epidemiology (12)
...
- Newly tracked story cluster: 121 item(s) across 91 source(s).
...
## Major topics
### Measles transmission and vaccination
- Topic size: 121 item(s) across 91 source(s); 1 official/primary-source item(s).
