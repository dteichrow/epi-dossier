...
- Category mix: Outbreaks and emerging infections (156), Policy, surveillance, and public health infrastructure (14), Major epidemiology studies (3)
...
## Major topics
### Ebola virus disease
- Topic size: 124 item(s) across 88 source(s); 5 official/primary-source item(s).
