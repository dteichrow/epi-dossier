...
- Category mix: Outbreaks and emerging infections (143), Policy, surveillance, and public health infrastructure (22), Major epidemiology studies (2)
...
## Major topics
### Ebola virus disease
- Topic size: 123 item(s) across 92 source(s); 2 official/primary-source item(s).
