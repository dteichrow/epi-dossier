...
- Category mix: Outbreaks and emerging infections (202), Policy, surveillance, and public health infrastructure (25), Occupational and environmental epidemiology (12)
...
### Ebola virus disease
- Topic size: 46 item(s) across 40 source(s); 2 official/primary-source item(s).
...
### Dengue and arboviruses
- Topic size: 29 item(s) across 24 source(s); 1 official/primary-source item(s).
