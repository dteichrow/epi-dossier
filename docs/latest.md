...
- Newly tracked story cluster: 246 item(s) across 144 source(s).
- Baseline snapshot created with 246 clustered item(s) across 144 source(s).
...
## Major topics
### Ebola virus disease
- Topic size: 246 item(s) across 144 source(s); 6 official/primary-source item(s).
