...
- Category mix: Outbreaks and emerging infections (127), Policy, surveillance, and public health infrastructure (20), Major epidemiology studies (3)
...
## Major topics
### Ebola virus disease
- Topic size: 102 item(s) across 79 source(s); 5 official/primary-source item(s).
...
### Hantavirus and cruise-ship outbreak
- Topic size: 19 item(s) across 16 source(s); 2 official/primary-source item(s).
