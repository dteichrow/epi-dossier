...
- Category mix: Outbreaks and emerging infections (298), Policy, surveillance, and public health infrastructure (43), Major epidemiology studies (7)
...
- Newly tracked story cluster: 157 item(s) across 95 source(s).
- Baseline snapshot created with 157 clustered item(s) across 95 source(s).
...
## Major topics
### Cyclosporiasis
- Topic size: 157 item(s) across 95 source(s); 2 official/primary-source item(s).
