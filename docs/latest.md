...
- Category mix: Outbreaks and emerging infections (220), Policy, surveillance, and public health infrastructure (24), Occupational and environmental epidemiology (8)
...
## Major topics
### Measles transmission and vaccination
- Topic size: 117 item(s) across 90 source(s); 1 official/primary-source item(s).
...
### Ebola virus disease
- Topic size: 64 item(s) across 51 source(s); 5 official/primary-source item(s).
