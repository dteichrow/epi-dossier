...
- Category mix: Outbreaks and emerging infections (256), Policy, surveillance, and public health infrastructure (26), Major epidemiology studies (3)
...
- Newly tracked story cluster: 250 item(s) across 155 source(s).
- Baseline snapshot created with 250 clustered item(s) across 155 source(s).
...
## Major topics
### Ebola virus disease
- Topic size: 250 item(s) across 155 source(s); 5 official/primary-source item(s).
