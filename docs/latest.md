...
- Category mix: Outbreaks and emerging infections (127), Policy, surveillance, and public health infrastructure (10), Major epidemiology studies (5)
...
- Newly tracked story cluster: 118 item(s) across 77 source(s).
- Baseline snapshot created with 118 clustered item(s) across 77 source(s).
...
## Major topics
### Ebola virus disease
- Topic size: 118 item(s) across 77 source(s); 2 official/primary-source item(s).
