...
- Category mix: Outbreaks and emerging infections (229), Policy, surveillance, and public health infrastructure (61), Historical epidemiology / ancient disease / paleopathology (3)
...
- Newly tracked story cluster: 185 item(s) across 105 source(s).
- Baseline snapshot created with 185 clustered item(s) across 105 source(s).
...
## Major topics
### Cyclosporiasis
- Topic size: 185 item(s) across 105 source(s); 4 official/primary-source item(s).
