...
- Newly tracked story cluster: 248 item(s) across 137 source(s).
- Baseline snapshot created with 248 clustered item(s) across 137 source(s).
...
## Major topics
### Ebola virus disease
- Topic size: 248 item(s) across 137 source(s); 6 official/primary-source item(s).
