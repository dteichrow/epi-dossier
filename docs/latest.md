...
- Category mix: Outbreaks and emerging infections (128), Policy, surveillance, and public health infrastructure (15), Major epidemiology studies (3)
- Source health: 4 source(s) failed during collection: Nigeria Centre for Disease Control, FDA Foodborne Outbreaks, USDA APHIS Avian Influenza, medRxiv Infectious Disease.
...
- Detailed note: Cluster remains active across 103 related item(s), but usable factual summary text was limited after cleanup.
