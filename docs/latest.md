...
- Category mix: Outbreaks and emerging infections (152), Policy, surveillance, and public health infrastructure (11), Occupational and environmental epidemiology (8)
...
### Measles transmission and vaccination
- Topic size: 34 item(s) across 32 source(s); 2 official/primary-source item(s).
