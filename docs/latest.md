...
- Category mix: Outbreaks and emerging infections (167), Policy, surveillance, and public health infrastructure (5), Major epidemiology studies (2)
...
- Newly tracked story cluster: 123 item(s) across 90 source(s).
- Baseline snapshot created with 123 clustered item(s) across 90 source(s).
...
## Major topics
### Ebola virus disease
- Topic size: 123 item(s) across 90 source(s); 6 official/primary-source item(s).
