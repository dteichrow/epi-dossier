...
- Newly tracked story cluster: 112 item(s) across 71 source(s).
- Baseline snapshot created with 112 clustered item(s) across 71 source(s).
...
## Major topics
### Ebola virus disease
- Topic size: 112 item(s) across 71 source(s); 3 official/primary-source item(s).
