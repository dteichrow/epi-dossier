...
- Category mix: Outbreaks and emerging infections (244), Policy, surveillance, and public health infrastructure (21), Major epidemiology studies (4)
...
## Major topics
### Ebola virus disease
- Topic size: 235 item(s) across 140 source(s); 4 official/primary-source item(s).
