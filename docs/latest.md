...
- Newly tracked story cluster: 89 item(s) across 58 source(s).
- Baseline snapshot created with 89 clustered item(s) across 58 source(s).
...
## Major topics
### Ebola virus disease
- Topic size: 89 item(s) across 58 source(s); 4 official/primary-source item(s).
