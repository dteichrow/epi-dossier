...
- Category mix: Outbreaks and emerging infections (150), Policy, surveillance, and public health infrastructure (16), Historical epidemiology / ancient disease / paleopathology (2)
...
## Major topics
### Ebola virus disease
- Topic size: 135 item(s) across 109 source(s); 4 official/primary-source item(s).
...
### Measles transmission and vaccination
- Topic size: 16 item(s) across 14 source(s); 3 official/primary-source item(s).
