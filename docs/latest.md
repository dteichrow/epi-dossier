...
- New publisher/source coverage joined this story cluster: South China Morning Post, 巴士的報.
- Story volume increased from 110 to 111 clustered item(s) in the current window.
- 1 newly observed linked item(s) were added since the last saved snapshot.


## Major topics
### Ebola virus disease
- Topic size: 111 item(s) across 65 source(s); 3 official/primary-source item(s).
