...
- Category mix: Outbreaks and emerging infections (241), Policy, surveillance, and public health infrastructure (25), Major epidemiology studies (1)
...
## Major topics
### Ebola virus disease
- Topic size: 236 item(s) across 141 source(s); 6 official/primary-source item(s).
