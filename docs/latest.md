...
- Newly tracked story cluster: 54 item(s) across 40 source(s).
- Baseline snapshot created with 54 clustered item(s) across 40 source(s).
...
### Cyclosporiasis
- Topic size: 54 item(s) across 40 source(s); 1 official/primary-source item(s).
