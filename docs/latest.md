...
- Newly tracked story cluster: 142 item(s) across 109 source(s).
- Baseline snapshot created with 142 clustered item(s) across 109 source(s).
...
## Major topics
### Measles transmission and vaccination
- Topic size: 142 item(s) across 109 source(s); 3 official/primary-source item(s).
