...
- Category mix: Outbreaks and emerging infections (205), Policy, surveillance, and public health infrastructure (31), Major epidemiology studies (3)
- Source health: 1 source(s) failed during collection: USDA APHIS Avian Influenza.

## Ongoing stories and what changed
### Ebola virus disease
- Lead item: [Ebola disease outbreak in the Democratic Republic of the Congo and Uganda](https://www.ecdc.europa.eu/en/ebola-outbreak-democratic-republic-congo-and-uganda) (ECDC News)
- Newly tracked story cluster: 226 item(s) across 120 source(s).
- Baseline snapshot created with 226 clustered item(s) across 120 source(s).
...
## Major topics
### Ebola virus disease
- Topic size: 226 item(s) across 120 source(s); 5 official/primary-source item(s).
