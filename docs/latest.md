...
- Category mix: Outbreaks and emerging infections (207), Policy, surveillance, and public health infrastructure (23), Historical epidemiology / ancient disease / paleopathology (5)
...
### Ebola virus disease
- Topic size: 68 item(s) across 58 source(s); 5 official/primary-source item(s).
