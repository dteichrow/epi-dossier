...
- Category mix: Outbreaks and emerging infections (182), Policy, surveillance, and public health infrastructure (27), Occupational and environmental epidemiology (11)
...
- Newly tracked story cluster: 102 item(s) across 65 source(s).
- Baseline snapshot created with 102 clustered item(s) across 65 source(s).
...
## Major topics
### Cyclosporiasis
- Topic size: 102 item(s) across 65 source(s); 4 official/primary-source item(s).
...
### Ebola virus disease
- Topic size: 94 item(s) across 64 source(s); 3 official/primary-source item(s).
