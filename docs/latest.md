...
- Category mix: Outbreaks and emerging infections (239), Policy, surveillance, and public health infrastructure (24), Major epidemiology studies (1)
...
## Major topics
### Ebola virus disease
- Topic size: 236 item(s) across 142 source(s); 5 official/primary-source item(s).
