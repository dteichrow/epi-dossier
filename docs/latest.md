...
- Category mix: Outbreaks and emerging infections (209), Policy, surveillance, and public health infrastructure (23), Major epidemiology studies (3)
...
## Major topics
### Ebola virus disease
- Topic size: 199 item(s) across 132 source(s); 5 official/primary-source item(s).
