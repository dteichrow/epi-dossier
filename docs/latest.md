...
- Category mix: Outbreaks and emerging infections (162), Policy, surveillance, and public health infrastructure (17), Virology and pathogen evolution (2)
...
- Newly tracked story cluster: 141 item(s) across 98 source(s).
- Baseline snapshot created with 141 clustered item(s) across 98 source(s).
