...
- Newly tracked story cluster: 221 item(s) across 130 source(s).
- Baseline snapshot created with 221 clustered item(s) across 130 source(s).
...
## Major topics
### Ebola virus disease
- Topic size: 221 item(s) across 130 source(s); 5 official/primary-source item(s).
