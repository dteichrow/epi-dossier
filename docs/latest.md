...
- Category mix: Outbreaks and emerging infections (228), Policy, surveillance, and public health infrastructure (26), Occupational and environmental epidemiology (2)
- Source health: 1 source(s) failed during collection: USDA APHIS Avian Influenza.

## Ongoing stories and what changed
### Ebola virus disease
- Lead item: [Ebola disease outbreak in the Democratic Republic of the Congo and Uganda](https://www.ecdc.europa.eu/en/ebola-outbreak-democratic-republic-congo-and-uganda) (ECDC News)
- Newly tracked story cluster: 227 item(s) across 129 source(s).
- Baseline snapshot created with 227 clustered item(s) across 129 source(s).
...
## Major topics
### Ebola virus disease
- Topic size: 227 item(s) across 129 source(s); 5 official/primary-source item(s).
