...
- Category mix: Outbreaks and emerging infections (286), Policy, surveillance, and public health infrastructure (38), Major epidemiology studies (6)

## Ongoing stories and what changed
### Cyclosporiasis
- Lead item: [Toledo-Lucas County Health Department Cyclosporiasis Update](https://lucascountyhealth.com/cyclo/) (Toledo-Lucas County Health Department Cyclosporiasis Update)
- Newly tracked story cluster: 148 item(s) across 96 source(s).
- Baseline snapshot created with 148 clustered item(s) across 96 source(s).
...
## Major topics
### Cyclosporiasis
- Topic size: 148 item(s) across 96 source(s); 4 official/primary-source item(s).
