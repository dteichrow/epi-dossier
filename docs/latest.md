...
- Category mix: Outbreaks and emerging infections (289), Policy, surveillance, and public health infrastructure (17), Historical epidemiology / ancient disease / paleopathology (2)
- Source health: 1 source(s) failed during collection: Nigeria Centre for Disease Control.

## Ongoing stories and what changed
### Ebola virus disease
- Lead item: [Ebola disease outbreak in the Democratic Republic of the Congo and Uganda](https://www.ecdc.europa.eu/en/ebola-outbreak-democratic-republic-congo-and-uganda) (ECDC News)
- Newly tracked story cluster: 140 item(s) across 99 source(s).
- Baseline snapshot created with 140 clustered item(s) across 99 source(s).
...
## Major topics
### Ebola virus disease
- Topic size: 140 item(s) across 99 source(s); 2 official/primary-source item(s).
