...
- Category mix: Outbreaks and emerging infections (243), Policy, surveillance, and public health infrastructure (24), Major epidemiology studies (1)
...
## Major topics
### Ebola virus disease
- Topic size: 236 item(s) across 140 source(s); 6 official/primary-source item(s).
