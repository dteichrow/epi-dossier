...
- Category mix: Outbreaks and emerging infections (122), Policy, surveillance, and public health infrastructure (26), Major epidemiology studies (3)
...
## Major topics
### Ebola virus disease
- Topic size: 119 item(s) across 79 source(s); 4 official/primary-source item(s).
