...
- Category mix: Outbreaks and emerging infections (219), Policy, surveillance, and public health infrastructure (26), Major epidemiology studies (3)
...
## Major topics
### Ebola virus disease
- Topic size: 236 item(s) across 126 source(s); 5 official/primary-source item(s).
