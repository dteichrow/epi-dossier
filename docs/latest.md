...
- Category mix: Outbreaks and emerging infections (149), Policy, surveillance, and public health infrastructure (20), Major epidemiology studies (4)
...
## Major topics
### Ebola virus disease
- Topic size: 136 item(s) across 91 source(s); 4 official/primary-source item(s).
