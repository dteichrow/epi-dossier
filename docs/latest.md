...
- Category mix: Outbreaks and emerging infections (165), Policy, surveillance, and public health infrastructure (15), Virology and pathogen evolution (2)
...
## Major topics
### Ebola virus disease
- Topic size: 142 item(s) across 99 source(s); 3 official/primary-source item(s).
