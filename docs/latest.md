...
- Baseline snapshot created with 135 clustered item(s) across 99 source(s).
...
## Major topics
### Ebola virus disease
- Topic size: 135 item(s) across 99 source(s); 2 official/primary-source item(s).
...
### Hantavirus and cruise-ship outbreak
- Topic size: 29 item(s) across 26 source(s); 4 official/primary-source item(s).
...
- Source: NewsNation
- Date: 2026-06-26T10:49+00:00
- URL: https://www.newsnationnow.com/health/white-house-congress-1-4b-ebola/
- Category: Outbreaks and emerging infections
- Summary: Limited detail was available from feed metadata alone.
