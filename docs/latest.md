...
- Category mix: Outbreaks and emerging infections (181), Policy, surveillance, and public health infrastructure (15), Historical epidemiology / ancient disease / paleopathology (2)
...
## Major topics
### Ebola virus disease
- Topic size: 133 item(s) across 103 source(s); 4 official/primary-source item(s).
...
### Measles transmission and vaccination
- Topic size: 46 item(s) across 41 source(s); 3 official/primary-source item(s).
