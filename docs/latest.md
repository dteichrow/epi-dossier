...
- Category mix: Outbreaks and emerging infections (105), Occupational and environmental epidemiology (17), Historical epidemiology / ancient disease / paleopathology (5)
...
- Newly tracked story cluster: 102 item(s) across 62 source(s).
- Baseline snapshot created with 102 clustered item(s) across 62 source(s).
- PubMed Infectious Disease Search now includes deaths or fatal cases in the story frame.
- PubMed Infectious Disease Search now foregrounds vaccination or vaccine policy in the story.
...
- Newly tracked story cluster: 17 item(s) across 11 source(s).
- Baseline snapshot created with 17 clustered item(s) across 11 source(s).
...
## Major topics
### Ebola virus disease
- Topic size: 102 item(s) across 62 source(s); 4 official/primary-source item(s).
...
### Occupational and environmental epidemiology
- Topic size: 17 item(s) across 11 source(s); 2 official/primary-source item(s).
