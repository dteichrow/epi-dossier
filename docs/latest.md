...
- Category mix: Outbreaks and emerging infections (144), Policy, surveillance, and public health infrastructure (16), Historical epidemiology / ancient disease / paleopathology (2)
...
- Newly tracked story cluster: 120 item(s) across 90 source(s).
- Baseline snapshot created with 120 clustered item(s) across 90 source(s).
...
## Major topics
### Ebola virus disease
- Topic size: 120 item(s) across 90 source(s); 5 official/primary-source item(s).
...
- Evidence notes: [Leptospirosis is associated with severity, increased resource utilization, and mortality among acute febrile illnesses from Karnataka, Southwestern India.](https://pubmed.ncbi.nlm.nih.gov/42311109/) (PubMed Infectious Disease Search); [India: Kerala reports uptick in dengue](https://outbreaknewstoday.substack.com/p/india-kerala-reports-uptick-in-dengue) (Outbreak News Today); [Fort Bend County to conduct aerial mosquito spraying amid public health emergency](https://news.google.?oc=5) (Click2Houston)
