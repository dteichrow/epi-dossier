...
- Category mix: Outbreaks and emerging infections (221), Policy, surveillance, and public health infrastructure (61), Historical epidemiology / ancient disease / paleopathology (3)
...
- Newly tracked story cluster: 177 item(s) across 101 source(s).
- Baseline snapshot created with 177 clustered item(s) across 101 source(s).
...
## Major topics
### Cyclosporiasis
- Topic size: 177 item(s) across 101 source(s); 2 official/primary-source item(s).
