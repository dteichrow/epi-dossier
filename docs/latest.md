...
- Category mix: Outbreaks and emerging infections (250), Policy, surveillance, and public health infrastructure (62), Historical epidemiology / ancient disease / paleopathology (3)
...
- Newly tracked story cluster: 113 item(s) across 84 source(s).
- Baseline snapshot created with 113 clustered item(s) across 84 source(s).
...
### Ebola virus disease
- Topic size: 113 item(s) across 84 source(s); 5 official/primary-source item(s).
