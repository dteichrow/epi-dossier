...
- Category mix: Outbreaks and emerging infections (130), Policy, surveillance, and public health infrastructure (19), Occupational and environmental epidemiology (6)
...
- Baseline snapshot created with 138 clustered item(s) across 102 source(s).
...
## Major topics
### Ebola virus disease
- Topic size: 138 item(s) across 102 source(s); 3 official/primary-source item(s).
