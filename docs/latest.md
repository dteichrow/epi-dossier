...
- Category mix: Outbreaks and emerging infections (237), Policy, surveillance, and public health infrastructure (24), Occupational and environmental epidemiology (2)
...
## Major topics
### Ebola virus disease
- Topic size: 234 item(s) across 127 source(s); 5 official/primary-source item(s).
