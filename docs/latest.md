...
- Category mix: Outbreaks and emerging infections (154), Policy, surveillance, and public health infrastructure (14), Historical epidemiology / ancient disease / paleopathology (2)
...
- Baseline snapshot created with 137 clustered item(s) across 108 source(s).
...
## Major topics
### Ebola virus disease
- Topic size: 137 item(s) across 108 source(s); 4 official/primary-source item(s).
...
### Measles transmission and vaccination
- Topic size: 15 item(s) across 15 source(s); 3 official/primary-source item(s).
