...
- Category mix: Outbreaks and emerging infections (204), Policy, surveillance, and public health infrastructure (20), Major epidemiology studies (3)
...
## Major topics
### Ebola virus disease
- Topic size: 210 item(s) across 130 source(s); 4 official/primary-source item(s).
