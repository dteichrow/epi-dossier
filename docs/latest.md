...
- Category mix: Outbreaks and emerging infections (258), Policy, surveillance, and public health infrastructure (57), Historical epidemiology / ancient disease / paleopathology (5)
...
- Newly tracked story cluster: 202 item(s) across 122 source(s).
- Baseline snapshot created with 202 clustered item(s) across 122 source(s).
...
- Newly tracked story cluster: 104 item(s) across 68 source(s).
- Baseline snapshot created with 104 clustered item(s) across 68 source(s).
...
## Major topics
### Cyclosporiasis
- Topic size: 202 item(s) across 122 source(s); 1 official/primary-source item(s).
