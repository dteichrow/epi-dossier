...
- Category mix: Outbreaks and emerging infections (128), Policy, surveillance, and public health infrastructure (10), Major epidemiology studies (3)
...
- Newly tracked story cluster: 121 item(s) across 80 source(s).
- Baseline snapshot created with 121 clustered item(s) across 80 source(s).
...
## Major topics
### Ebola virus disease
- Topic size: 121 item(s) across 80 source(s); 2 official/primary-source item(s).
