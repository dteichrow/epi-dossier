...
- Category mix: Outbreaks and emerging infections (254), Policy, surveillance, and public health infrastructure (20), Major epidemiology studies (5)
...
### Measles transmission and vaccination
- Topic size: 39 item(s) across 34 source(s); 3 official/primary-source item(s).
