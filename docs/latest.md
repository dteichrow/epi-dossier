...
- Lead item: [Virginia reports unsettling first case of local dengue spread](https://rollingout.com/2026/08/05/virginia-reports-first-case-local-dengue/) (Rolling Out)
- Newly tracked story cluster: 3 item(s) across 3 source(s).
- Baseline snapshot created with 3 clustered item(s) across 3 source(s).
- Rolling Out now explicitly uses investigation or monitoring language.
- bnionline.net now includes deaths or fatal cases in the story frame.
