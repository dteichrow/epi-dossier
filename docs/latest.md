...
- Category mix: Outbreaks and emerging infections (117), Policy, surveillance, and public health infrastructure (9), Occupational and environmental epidemiology (8)
...
## Major topics
### Ebola virus disease
- Topic size: 93 item(s) across 65 source(s); 5 official/primary-source item(s).
