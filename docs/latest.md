...
- Newly tracked story cluster: 240 item(s) across 145 source(s).
- Baseline snapshot created with 240 clustered item(s) across 145 source(s).
...
## Major topics
### Ebola virus disease
- Topic size: 240 item(s) across 145 source(s); 5 official/primary-source item(s).
