...
- Category mix: Outbreaks and emerging infections (53), Policy, surveillance, and public health infrastructure (3)
...
- Topic size: 47 item(s) across 23 source(s); 3 official/primary-source item(s).
