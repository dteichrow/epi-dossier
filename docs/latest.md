...
- Newly tracked story cluster: 111 item(s) across 70 source(s).
- Baseline snapshot created with 111 clustered item(s) across 70 source(s).
...
## Major topics
### Ebola virus disease
- Topic size: 111 item(s) across 70 source(s); 3 official/primary-source item(s).
...
- Detailed note: Health officials in Lamu County have reported a cholera outbreak that has resulted in two deaths and affected 50 residents. Latest Stories AI-fuelled misinformation threatens refugees, aid workers, UNHCR warns Apple introduces new privacy warning for AI features using Google Cloud: What iPhone users in Kenya need to know Consumers face tighter gas supply, higher price risks through 2027 – report IEBC explains...
