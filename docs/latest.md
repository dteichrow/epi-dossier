...
- Category mix: Outbreaks and emerging infections (278), Policy, surveillance, and public health infrastructure (19), Major epidemiology studies (4)
...
- Newly tracked story cluster: 137 item(s) across 110 source(s).
- Baseline snapshot created with 137 clustered item(s) across 110 source(s).
...
## Major topics
### Measles transmission and vaccination
- Topic size: 137 item(s) across 110 source(s); 3 official/primary-source item(s).
