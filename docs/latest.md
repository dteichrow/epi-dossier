...
- Category mix: Outbreaks and emerging infections (102), Policy, surveillance, and public health infrastructure (4), Major epidemiology studies (3)
...
- Newly tracked story cluster: 98 item(s) across 58 source(s).
- Baseline snapshot created with 98 clustered item(s) across 58 source(s).
- WHO Regional Office for Africa now includes deaths or fatal cases in the story frame.


## Major topics
### Ebola virus disease
- Topic size: 98 item(s) across 58 source(s); 3 official/primary-source item(s).
...
- Date: 2026-07-09T12:00+00:00
- URL: https://www.timesfreepress.com/news/2026/jul/09/some-health-workers-in-congos-ebola-outbreak-go-on-strike-over-pay-issues-as-deaths-near-600/
- Category: Outbreaks and emerging infections
- Summary: The latest government data shows 1,708 recorded cases, including 580 deaths, and that the first month of this Ebola outbreak was already the worst on record, health authorities said. Biensi Kano, a member of the epidemiological surveillance committee in Ituri's capital, Bunia, told The Associated Press. In Ituri province, the hardest hit among the three provinces in eastern Congo affected by the outbreak, some of the health professionals and other front-line workers told The Associated Press they've not been paid their wages and bonuses since the outbreak was declared on May 15.
