...
- Category mix: Outbreaks and emerging infections (199), Policy, surveillance, and public health infrastructure (22), Occupational and environmental epidemiology (7)
...
- Newly tracked story cluster: 39 item(s) across 27 source(s).
...
### Dengue and arboviruses
- Topic size: 39 item(s) across 27 source(s); 1 official/primary-source item(s).
