...
- Newly tracked story cluster: 137 item(s) across 88 source(s).
- Baseline snapshot created with 137 clustered item(s) across 88 source(s).
...
## Major topics
### Ebola virus disease
- Topic size: 137 item(s) across 88 source(s); 4 official/primary-source item(s).
