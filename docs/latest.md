...
- Category mix: Outbreaks and emerging infections (262), Policy, surveillance, and public health infrastructure (58), Major epidemiology studies (5)
...
- Newly tracked story cluster: 103 item(s) across 68 source(s).
- Baseline snapshot created with 103 clustered item(s) across 68 source(s).
...
- Newly tracked story cluster: 205 item(s) across 123 source(s).
- Baseline snapshot created with 205 clustered item(s) across 123 source(s).
...
## Major topics
### Cyclosporiasis
- Topic size: 205 item(s) across 123 source(s); 2 official/primary-source item(s).
...
### Ebola virus disease
- Topic size: 103 item(s) across 68 source(s); 4 official/primary-source item(s).
...
- [Cases of cyclosporiasis in Michigan surpass 5,000, health officials say - ABC News - Breaking News, Latest News and Videos](https://abcnews.com/Health/cyclosporiasis-cases-michigan-surpass-2600-health-officials/story?id\=134709100) | ABC News - Breaking News, Latest News and Videos | 2026-07-18T09:12+00:00 | Outbreaks and emerging infections
  Limited detail was available from feed metadata alone.
