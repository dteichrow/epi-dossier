...
- Category mix: Outbreaks and emerging infections (173), Policy, surveillance, and public health infrastructure (40), Historical epidemiology / ancient disease / paleopathology (5)
...
- Newly tracked story cluster: 129 item(s) across 85 source(s).
- Baseline snapshot created with 129 clustered item(s) across 85 source(s).
...
## Major topics
### Cyclosporiasis
- Topic size: 129 item(s) across 85 source(s); 4 official/primary-source item(s).
