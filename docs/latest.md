...
- Category mix: Outbreaks and emerging infections (233), Policy, surveillance, and public health infrastructure (20), Major epidemiology studies (3)
...
## Major topics
### Ebola virus disease
- Topic size: 224 item(s) across 130 source(s); 5 official/primary-source item(s).
