...
- Category mix: Outbreaks and emerging infections (166), Policy, surveillance, and public health infrastructure (16), Major epidemiology studies (2)
...
- Baseline snapshot created with 133 clustered item(s) across 101 source(s).
...
## Major topics
### Ebola virus disease
- Topic size: 133 item(s) across 101 source(s); 5 official/primary-source item(s).
