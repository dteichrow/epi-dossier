...
- Category mix: Outbreaks and emerging infections (151), Policy, surveillance, and public health infrastructure (21), Historical epidemiology / ancient disease / paleopathology (2)
...
## Major topics
### Ebola virus disease
- Topic size: 132 item(s) across 109 source(s); 4 official/primary-source item(s).
