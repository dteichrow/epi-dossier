...
- Category mix: Outbreaks and emerging infections (272), Policy, surveillance, and public health infrastructure (27), Major epidemiology studies (3)
...
- Newly tracked story cluster: 250 item(s) across 145 source(s).
- Baseline snapshot created with 250 clustered item(s) across 145 source(s).
...
## Major topics
### Ebola virus disease
- Topic size: 250 item(s) across 145 source(s); 5 official/primary-source item(s).
...
### Hantavirus and cruise-ship outbreak
- Topic size: 20 item(s) across 16 source(s); 1 official/primary-source item(s).
