...
- Category mix: Outbreaks and emerging infections (206), Policy, surveillance, and public health infrastructure (24), Occupational and environmental epidemiology (7)
...
- Newly tracked story cluster: 58 item(s) across 46 source(s).
...
- theweek.in now foregrounds vaccination or vaccine policy in the story.
...
### Ebola virus disease
- Topic size: 58 item(s) across 46 source(s); 4 official/primary-source item(s).
