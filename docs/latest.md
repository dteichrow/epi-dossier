...
- Category mix: Outbreaks and emerging infections (148), Policy, surveillance, and public health infrastructure (9), Occupational and environmental epidemiology (5)
...
- Newly tracked story cluster: 109 item(s) across 65 source(s).
- Baseline snapshot created with 109 clustered item(s) across 65 source(s).
...
## Major topics
### Ebola virus disease
- Topic size: 109 item(s) across 65 source(s); 2 official/primary-source item(s).
