...
- Newly tracked story cluster: 139 item(s) across 97 source(s).
- Baseline snapshot created with 139 clustered item(s) across 97 source(s).
...
## Major topics
### Ebola virus disease
- Topic size: 139 item(s) across 97 source(s); 3 official/primary-source item(s).
