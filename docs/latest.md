...
- Newly tracked story cluster: 258 item(s) across 152 source(s).
- Baseline snapshot created with 258 clustered item(s) across 152 source(s).
...
## Major topics
### Ebola virus disease
- Topic size: 258 item(s) across 152 source(s); 6 official/primary-source item(s).
