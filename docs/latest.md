...
- Category mix: Outbreaks and emerging infections (140), Policy, surveillance, and public health infrastructure (21), Major epidemiology studies (2)
...
## Major topics
### Ebola virus disease
- Topic size: 120 item(s) across 89 source(s); 5 official/primary-source item(s).
