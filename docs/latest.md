...
- Category mix: Outbreaks and emerging infections (98), Occupational and environmental epidemiology (15), Policy, surveillance, and public health infrastructure (5)
...
- Newly tracked story cluster: 92 item(s) across 59 source(s).
- Baseline snapshot created with 92 clustered item(s) across 59 source(s).
...
## Major topics
### Ebola virus disease
- Topic size: 92 item(s) across 59 source(s); 4 official/primary-source item(s).
