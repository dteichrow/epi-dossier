...
- Newly tracked story cluster: 247 item(s) across 139 source(s).
- Baseline snapshot created with 247 clustered item(s) across 139 source(s).
...
## Major topics
### Ebola virus disease
- Topic size: 247 item(s) across 139 source(s); 4 official/primary-source item(s).
