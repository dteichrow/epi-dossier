...
- Newly tracked story cluster: 229 item(s) across 122 source(s).
- Baseline snapshot created with 229 clustered item(s) across 122 source(s).
...
## Major topics
### Ebola virus disease
- Topic size: 229 item(s) across 122 source(s); 5 official/primary-source item(s).
...
### Measles transmission and vaccination
- Topic size: 29 item(s) across 26 source(s); 2 official/primary-source item(s).
