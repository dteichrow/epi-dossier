...
- Newly tracked story cluster: 109 item(s) across 66 source(s).
- Baseline snapshot created with 109 clustered item(s) across 66 source(s).
...
## Major topics
### Ebola virus disease
- Topic size: 109 item(s) across 66 source(s); 3 official/primary-source item(s).
