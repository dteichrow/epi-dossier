...
- Newly tracked story cluster: 97 item(s) across 62 source(s).
- Baseline snapshot created with 97 clustered item(s) across 62 source(s).
...
## Major topics
### Ebola virus disease
- Topic size: 97 item(s) across 62 source(s); 4 official/primary-source item(s).
