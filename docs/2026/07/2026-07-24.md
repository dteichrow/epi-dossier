...
- Category mix: Outbreaks and emerging infections (224), Policy, surveillance, and public health infrastructure (59), Historical epidemiology / ancient disease / paleopathology (3)
...
- Newly tracked story cluster: 177 item(s) across 100 source(s).
- Baseline snapshot created with 177 clustered item(s) across 100 source(s).
...
## Major topics
### Cyclosporiasis
- Topic size: 177 item(s) across 100 source(s); 4 official/primary-source item(s).
