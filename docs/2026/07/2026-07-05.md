...
- Newly tracked story cluster: 20 item(s) across 9 source(s).
- Baseline snapshot created with 20 clustered item(s) across 9 source(s).
...
## Major topics
### Ebola virus disease
- Topic size: 20 item(s) across 9 source(s); 0 official/primary-source item(s).
