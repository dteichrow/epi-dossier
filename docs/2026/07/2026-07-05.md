...
- Newly tracked story cluster: 17 item(s) across 6 source(s).
- Baseline snapshot created with 17 clustered item(s) across 6 source(s).
...
## Major topics
### Ebola virus disease
- Topic size: 17 item(s) across 6 source(s); 0 official/primary-source item(s).
