...
- Category mix: Outbreaks and emerging infections (129), Policy, surveillance, and public health infrastructure (8), Occupational and environmental epidemiology (7)
...
## Major topics
### Ebola virus disease
- Topic size: 102 item(s) across 65 source(s); 3 official/primary-source item(s).
