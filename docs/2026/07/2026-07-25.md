...
- Category mix: Outbreaks and emerging infections (242), Policy, surveillance, and public health infrastructure (68), Historical epidemiology / ancient disease / paleopathology (3)
...
- Newly tracked story cluster: 192 item(s) across 112 source(s).
- Baseline snapshot created with 192 clustered item(s) across 112 source(s).
...
## Major topics
### Cyclosporiasis
- Topic size: 192 item(s) across 112 source(s); 4 official/primary-source item(s).
