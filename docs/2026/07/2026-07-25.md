...
- Category mix: Outbreaks and emerging infections (244), Policy, surveillance, and public health infrastructure (70), Historical epidemiology / ancient disease / paleopathology (3)
...
- Newly tracked story cluster: 196 item(s) across 115 source(s).
- Baseline snapshot created with 196 clustered item(s) across 115 source(s).
...
## Major topics
### Cyclosporiasis
- Topic size: 196 item(s) across 115 source(s); 4 official/primary-source item(s).
...
### Ebola virus disease
- Topic size: 106 item(s) across 77 source(s); 5 official/primary-source item(s).
