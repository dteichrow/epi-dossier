...
- Newly tracked story cluster: 91 item(s) across 58 source(s).
- Baseline snapshot created with 91 clustered item(s) across 58 source(s).
...
## Major topics
### Ebola virus disease
- Topic size: 91 item(s) across 58 source(s); 4 official/primary-source item(s).
