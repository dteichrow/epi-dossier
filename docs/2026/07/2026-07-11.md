...
- Newly tracked story cluster: 96 item(s) across 61 source(s).
- Baseline snapshot created with 96 clustered item(s) across 61 source(s).
...
## Major topics
### Ebola virus disease
- Topic size: 96 item(s) across 61 source(s); 4 official/primary-source item(s).
