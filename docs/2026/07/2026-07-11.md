...
- Category mix: Outbreaks and emerging infections (99), Occupational and environmental epidemiology (15), Major epidemiology studies (5)
...
## Major topics
### Ebola virus disease
- Topic size: 97 item(s) across 63 source(s); 4 official/primary-source item(s).
