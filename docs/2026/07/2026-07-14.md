...
- Category mix: Outbreaks and emerging infections (194), Policy, surveillance, and public health infrastructure (26), Occupational and environmental epidemiology (8)
...
- Newly tracked story cluster: 89 item(s) across 59 source(s).
- Baseline snapshot created with 89 clustered item(s) across 59 source(s).
