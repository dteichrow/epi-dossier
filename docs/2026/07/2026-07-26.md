...
- Category mix: Outbreaks and emerging infections (238), Policy, surveillance, and public health infrastructure (62), Historical epidemiology / ancient disease / paleopathology (5)
...
## Major topics
### Cyclosporiasis
- Topic size: 180 item(s) across 111 source(s); 4 official/primary-source item(s).
...
### Ebola virus disease
- Topic size: 110 item(s) across 79 source(s); 5 official/primary-source item(s).
