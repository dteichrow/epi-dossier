...
- Category mix: Outbreaks and emerging infections (246), Policy, surveillance, and public health infrastructure (58), Historical epidemiology / ancient disease / paleopathology (4)
...
- Newly tracked story cluster: 185 item(s) across 103 source(s).
- Baseline snapshot created with 185 clustered item(s) across 103 source(s).
...
## Major topics
### Cyclosporiasis
- Topic size: 185 item(s) across 103 source(s); 3 official/primary-source item(s).
