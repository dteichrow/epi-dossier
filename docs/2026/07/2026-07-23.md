...
- Newly tracked story cluster: 171 item(s) across 101 source(s).
- Baseline snapshot created with 171 clustered item(s) across 101 source(s).
...
## Major topics
### Cyclosporiasis
- Topic size: 171 item(s) across 101 source(s); 2 official/primary-source item(s).
...
### Ebola virus disease
- Topic size: 104 item(s) across 75 source(s); 5 official/primary-source item(s).
