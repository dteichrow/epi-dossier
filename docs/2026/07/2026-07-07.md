...
- Category mix: Outbreaks and emerging infections (119), Policy, surveillance, and public health infrastructure (6), Major epidemiology studies (3)
- Source health: 1 source(s) failed during collection: USDA APHIS Avian Influenza.

## Ongoing stories and what changed
### Ebola virus disease
- Lead item: [Ebola disease outbreak in the Democratic Republic of the Congo and Uganda](https://www.ecdc.europa.eu/en/ebola-outbreak-democratic-republic-congo-and-uganda) (ECDC News)
- Newly tracked story cluster: 112 item(s) across 69 source(s).
- Baseline snapshot created with 112 clustered item(s) across 69 source(s).
...
## Major topics
### Ebola virus disease
- Topic size: 112 item(s) across 69 source(s); 3 official/primary-source item(s).
