...
- Newly tracked story cluster: 111 item(s) across 69 source(s).
- Baseline snapshot created with 111 clustered item(s) across 69 source(s).
...
## Major topics
### Ebola virus disease
- Topic size: 111 item(s) across 69 source(s); 3 official/primary-source item(s).
