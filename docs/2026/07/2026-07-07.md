...
- Category mix: Outbreaks and emerging infections (142), Policy, surveillance, and public health infrastructure (8), Major epidemiology studies (4)
...
- New official source(s) joined this story cluster: ECDC News, Texas Department of State Health Services News, WHO Regional Office for Africa.
...
- Story volume increased from 17 to 108 clustered item(s) in the current window.
...
- The lead item has changed to [Next-generation vaccine adjuvants: Integrating nanotechnology, systems immunology, and computational approaches for precision vaccinology.](https://pubmed.ncbi.nlm.nih.gov/42405958/) from PubMed Infectious Disease Search.
...
## Major topics
### Ebola virus disease
- Topic size: 108 item(s) across 68 source(s); 3 official/primary-source item(s).
