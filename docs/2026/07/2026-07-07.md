...
- Category mix: Outbreaks and emerging infections (131), Occupational and environmental epidemiology (10), Policy, surveillance, and public health infrastructure (8)
...
- Newly tracked story cluster: 109 item(s) across 70 source(s).
- Baseline snapshot created with 109 clustered item(s) across 70 source(s).
...
## Major topics
### Ebola virus disease
- Topic size: 109 item(s) across 70 source(s); 3 official/primary-source item(s).
