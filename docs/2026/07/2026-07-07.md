...
- Category mix: Outbreaks and emerging infections (117), Policy, surveillance, and public health infrastructure (5), Major epidemiology studies (4)
...
## Major topics
### Ebola virus disease
- Topic size: 110 item(s) across 71 source(s); 3 official/primary-source item(s).
