...
- Category mix: Outbreaks and emerging infections (119), Major epidemiology studies (4), Policy, surveillance, and public health infrastructure (4)
...
## Major topics
### Ebola virus disease
- Topic size: 105 item(s) across 69 source(s); 3 official/primary-source item(s).
