...
- Category mix: Outbreaks and emerging infections (217), Policy, surveillance, and public health infrastructure (57), Historical epidemiology / ancient disease / paleopathology (4)
...
### Ebola virus disease
- Topic size: 85 item(s) across 63 source(s); 3 official/primary-source item(s).
