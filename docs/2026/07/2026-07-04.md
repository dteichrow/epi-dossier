...
- Category mix: Outbreaks and emerging infections (151), Policy, surveillance, and public health infrastructure (7), Occupational and environmental epidemiology (4)
...
- Newly tracked story cluster: 37 item(s) across 35 source(s).
- Baseline snapshot created with 37 clustered item(s) across 35 source(s).
