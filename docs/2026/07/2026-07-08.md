...
- Category mix: Outbreaks and emerging infections (111), Policy, surveillance, and public health infrastructure (3), Major epidemiology studies (2)
- Source health: 1 source(s) failed during collection: USDA APHIS Avian Influenza.

## Ongoing stories and what changed
### Ebola virus disease
- Lead item: [Ebola disease outbreak in the Democratic Republic of the Congo and Uganda](https://www.ecdc.europa.eu/en/ebola-outbreak-democratic-republic-congo-and-uganda) (ECDC News)
- New publisher/source coverage joined this story cluster: The Star Democrat.
- Story volume increased from 103 to 104 clustered item(s) in the current window.
