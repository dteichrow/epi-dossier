...
- Newly tracked story cluster: 103 item(s) across 63 source(s).
- Baseline snapshot created with 103 clustered item(s) across 63 source(s).
...
## Major topics
### Ebola virus disease
- Topic size: 103 item(s) across 63 source(s); 3 official/primary-source item(s).
...
- [Some health workers in Congo's Ebola outbreak go on strike over pay issues as deaths near 600](https://www.theintelligencer.com/news/world/article/some-health-workers-in-congo-s-ebola-outbreak-go-22336963.php) | The Edwardsville Intelligencer | 2026-07-08T07:51+00:00 | Outbreaks and emerging infections
  Limited detail was available from feed metadata alone.
