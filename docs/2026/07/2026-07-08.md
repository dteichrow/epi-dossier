...
- New publisher/source coverage joined this story cluster: Bangladesh Sangbad Sangstha (BSS), China Daily - Global Edition, Eagle-Tribune.
- 2 newly observed linked item(s) were added since the last saved snapshot.


## Major topics
### Ebola virus disease
- Topic size: 109 item(s) across 65 source(s); 3 official/primary-source item(s).
