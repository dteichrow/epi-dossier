...
- Category mix: Outbreaks and emerging infections (159), Policy, surveillance, and public health infrastructure (15), Major epidemiology studies (2)
...
## Major topics
### Ebola virus disease
- Topic size: 131 item(s) across 97 source(s); 6 official/primary-source item(s).
