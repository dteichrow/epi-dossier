...
- Category mix: Outbreaks and emerging infections (158), Policy, surveillance, and public health infrastructure (11), Major epidemiology studies (2)
...
- Newly tracked story cluster: 120 item(s) across 89 source(s).
- Baseline snapshot created with 120 clustered item(s) across 89 source(s).
...
## Major topics
### Ebola virus disease
- Topic size: 120 item(s) across 89 source(s); 6 official/primary-source item(s).
