...
- Category mix: Outbreaks and emerging infections (173), Policy, surveillance, and public health infrastructure (15), Major epidemiology studies (4)
...
- Baseline snapshot created with 30 clustered item(s) across 29 source(s).
...
- Newly tracked story cluster: 131 item(s) across 96 source(s).
- Baseline snapshot created with 131 clustered item(s) across 96 source(s).
...
## Major topics
### Ebola virus disease
- Topic size: 131 item(s) across 96 source(s); 5 official/primary-source item(s).
...
### Measles transmission and vaccination
- Topic size: 30 item(s) across 29 source(s); 2 official/primary-source item(s).
