...
- Category mix: Outbreaks and emerging infections (150), Policy, surveillance, and public health infrastructure (23), Major epidemiology studies (2)
...
## Major topics
### Ebola virus disease
- Topic size: 119 item(s) across 88 source(s); 5 official/primary-source item(s).
