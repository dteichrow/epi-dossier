...
- Baseline snapshot created with 121 clustered item(s) across 93 source(s).
...
## Major topics
### Ebola virus disease
- Topic size: 121 item(s) across 93 source(s); 5 official/primary-source item(s).
