...
- Baseline snapshot created with 119 clustered item(s) across 89 source(s).
...
## Major topics
### Ebola virus disease
- Topic size: 119 item(s) across 89 source(s); 5 official/primary-source item(s).
