...
- Category mix: Outbreaks and emerging infections (135), Policy, surveillance, and public health infrastructure (18), Major epidemiology studies (3)
...
## Major topics
### Ebola virus disease
- Topic size: 115 item(s) across 82 source(s); 5 official/primary-source item(s).
