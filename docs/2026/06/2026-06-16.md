...
- Category mix: Outbreaks and emerging infections (126), Occupational and environmental epidemiology (9), Major epidemiology studies (4)
...
## Major topics
### Ebola virus disease
- Topic size: 118 item(s) across 84 source(s); 4 official/primary-source item(s).
