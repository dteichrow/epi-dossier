...
- Category mix: Outbreaks and emerging infections (118), Policy, surveillance, and public health infrastructure (10), Major epidemiology studies (4)
...
## Major topics
### Ebola virus disease
- Topic size: 118 item(s) across 82 source(s); 4 official/primary-source item(s).
