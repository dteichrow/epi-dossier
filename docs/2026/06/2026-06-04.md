...
- Newly tracked story cluster: 224 item(s) across 138 source(s).
- Baseline snapshot created with 224 clustered item(s) across 138 source(s).
...
## Major topics
### Ebola virus disease
- Topic size: 224 item(s) across 138 source(s); 3 official/primary-source item(s).
