...
- Newly tracked story cluster: 126 item(s) across 77 source(s).
- Baseline snapshot created with 126 clustered item(s) across 77 source(s).
...
## Major topics
### Ebola virus disease
- Topic size: 126 item(s) across 77 source(s); 4 official/primary-source item(s).
