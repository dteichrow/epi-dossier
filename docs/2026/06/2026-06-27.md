...
- Category mix: Outbreaks and emerging infections (160), Policy, surveillance, and public health infrastructure (6), Major epidemiology studies (4)
...
- Newly tracked story cluster: 133 item(s) across 83 source(s).
- Baseline snapshot created with 133 clustered item(s) across 83 source(s).
...
## Major topics
### Ebola virus disease
- Topic size: 133 item(s) across 83 source(s); 4 official/primary-source item(s).
