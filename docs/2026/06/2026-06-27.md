...
- Category mix: Outbreaks and emerging infections (159), Policy, surveillance, and public health infrastructure (16), Major epidemiology studies (4)
...
## Major topics
### Ebola virus disease
- Topic size: 139 item(s) across 86 source(s); 4 official/primary-source item(s).
