...
- Category mix: Outbreaks and emerging infections (172), Policy, surveillance, and public health infrastructure (18), Virology and pathogen evolution (2)
...
- New publisher/source coverage joined this story cluster: 104.5 WOKV, AJMC, Al Jazeera.
- The lead item has changed to [Multi-country Salmonella outbreak linked to alfalfa sprouted seeds](https://www.ecdc.europa.eu/en/news-events/multi-country-salmonella-outbreak-linked-alfalfa-sprouted-seeds) from ECDC News.
- Story volume increased from 22 to 33 clustered item(s) in the current window.
...
- New publisher/source coverage joined this story cluster: Daily Mirror - Sri Lanka.
- The lead item has changed to [Don’t guess at home whether it’s dengue or flu-get checked early: Doctors - Daily Mirror](https://www.dailymirror.lk/print/front-page/Dont-guess-at-home-whether-its-dengue-or-flu-get-checked-early-Doctors/238-343856) from Daily Mirror - Sri Lanka.
- 1 newly observed linked item(s) were added since the last saved snapshot.

### Ebola virus disease
- Lead item: [Ebola disease outbreak in the Democratic Republic of the Congo and Uganda](https://www.ecdc.europa.eu/en/ebola-outbreak-democratic-republic-congo-and-uganda) (ECDC News)
- New publisher/source coverage joined this story cluster: African Arguments, Bloomberg, Business Insider Africa.
- Story volume increased from 102 to 119 clustered item(s) in the current window.
...
## Major topics
### Ebola virus disease
- Topic size: 119 item(s) across 88 source(s); 2 official/primary-source item(s).
