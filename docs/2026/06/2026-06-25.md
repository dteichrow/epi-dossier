...
- Category mix: Outbreaks and emerging infections (145), Policy, surveillance, and public health infrastructure (19), Major epidemiology studies (2)
...
## Major topics
### Ebola virus disease
- Topic size: 121 item(s) across 89 source(s); 2 official/primary-source item(s).
