...
- Baseline snapshot created with 24 clustered item(s) across 19 source(s).
...
## Major topics
### Ebola virus disease
- Topic size: 128 item(s) across 102 source(s); 4 official/primary-source item(s).
...
### Measles transmission and vaccination
- Topic size: 24 item(s) across 19 source(s); 3 official/primary-source item(s).
