...
- Category mix: Outbreaks and emerging infections (163), Policy, surveillance, and public health infrastructure (18), Major epidemiology studies (4)
...
- Newly tracked story cluster: 141 item(s) across 90 source(s).
- Baseline snapshot created with 141 clustered item(s) across 90 source(s).
...
## Major topics
### Ebola virus disease
- Topic size: 141 item(s) across 90 source(s); 4 official/primary-source item(s).
