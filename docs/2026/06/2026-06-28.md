...
- Newly tracked story cluster: 149 item(s) across 104 source(s).
- Baseline snapshot created with 149 clustered item(s) across 104 source(s).
...
## Major topics
### Ebola virus disease
- Topic size: 149 item(s) across 104 source(s); 4 official/primary-source item(s).
...
- [DR Congo's Ebola Cases Top 1,200, Death Toll Reaches 321](https://en.tempo.co/read/2110769/dr-congos-ebola-cases-top-1200-death-toll-reaches-321) | Tempo.co English | 2026-06-28T04:16+00:00 | Outbreaks and emerging infections
  Limited detail was available from feed metadata alone.
