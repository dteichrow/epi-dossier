...
- Category mix: Outbreaks and emerging infections (157), Policy, surveillance, and public health infrastructure (22), Major epidemiology studies (4)
...
- Newly tracked story cluster: 145 item(s) across 96 source(s).
- Baseline snapshot created with 145 clustered item(s) across 96 source(s).
...
## Major topics
### Ebola virus disease
- Topic size: 145 item(s) across 96 source(s); 4 official/primary-source item(s).
