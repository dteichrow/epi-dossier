...
- Category mix: Outbreaks and emerging infections (149), Policy, surveillance, and public health infrastructure (15), Historical epidemiology / ancient disease / paleopathology (2)
...
- Newly tracked story cluster: 122 item(s) across 95 source(s).
- Baseline snapshot created with 122 clustered item(s) across 95 source(s).
...
## Major topics
### Ebola virus disease
- Topic size: 122 item(s) across 95 source(s); 4 official/primary-source item(s).
