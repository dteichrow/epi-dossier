...
- Category mix: Outbreaks and emerging infections (173), Policy, surveillance, and public health infrastructure (17), Historical epidemiology / ancient disease / paleopathology (2)
...
- New publisher/source coverage joined this story cluster: A News, Africa.com, Asianet Newsable.
- The lead item has changed to [ECDC publishes practical guidance to improve Ebola preparedness](https://www.ecdc.europa.eu/en/news-events/ecdc-publishes-practical-guidance-improve-ebola-preparedness) from ECDC News.
- Story volume increased from 125 to 126 clustered item(s) in the current window.
...
- New official source(s) joined this story cluster: PubMed Historical Epidemiology.
- The lead item has changed to [Neutralising antibody responses to MPXV clades Ia, Ib, and IIb after infection or vaccination: a multicountry observational study.](https://pubmed.ncbi.nlm.nih.gov/42314719/) from PubMed Historical Pathogen Case Studies.
...
- The lead item has changed to [Notes from the Field: Initial Public Health Response to a Measles Outbreak in a Close-Knit West Texas Community](https://tools.cdc.gov/api/embed/downloader/download.asp?m=342778&c=765860) from CDC MMWR.
- 7 newly observed linked item(s) were added since the last saved snapshot.
...
- New publisher/source coverage joined this story cluster: The Times of India, TradingView.
- The lead item has changed to [119 dengue cases recorded in Singapore in second week of June, highest so far in 2026](https://www.straitstimes.com/singapore/119-dengue-cases-recorded-in-singapore-in-second-week-of-june-highest-so-far-in-2026) from The Straits Times.
- 2 newly observed linked item(s) were added since the last saved snapshot.
...
- New publisher/source coverage joined this story cluster: Nebraska Examiner, WOWT.
