...
- Baseline snapshot created with 135 clustered item(s) across 105 source(s).
...
## Major topics
### Ebola virus disease
- Topic size: 135 item(s) across 105 source(s); 4 official/primary-source item(s).
