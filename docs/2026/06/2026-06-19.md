...
- Category mix: Outbreaks and emerging infections (164), Policy, surveillance, and public health infrastructure (16), Historical epidemiology / ancient disease / paleopathology (2)
...
- Newly tracked story cluster: 139 item(s) across 107 source(s).
- Baseline snapshot created with 139 clustered item(s) across 107 source(s).
...
## Major topics
### Ebola virus disease
- Topic size: 139 item(s) across 107 source(s); 4 official/primary-source item(s).
