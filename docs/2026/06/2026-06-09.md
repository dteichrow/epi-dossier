...
- Category mix: Outbreaks and emerging infections (154), Policy, surveillance, and public health infrastructure (27), Occupational and environmental epidemiology (4)
...
- Newly tracked story cluster: 175 item(s) across 117 source(s).
- Baseline snapshot created with 175 clustered item(s) across 117 source(s).
...
## Major topics
### Ebola virus disease
- Topic size: 175 item(s) across 117 source(s); 4 official/primary-source item(s).
