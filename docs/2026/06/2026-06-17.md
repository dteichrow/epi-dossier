...
- Category mix: Outbreaks and emerging infections (142), Policy, surveillance, and public health infrastructure (9), Occupational and environmental epidemiology (8)
...
## Major topics
### Ebola virus disease
- Topic size: 114 item(s) across 77 source(s); 5 official/primary-source item(s).
