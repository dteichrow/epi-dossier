...
- Category mix: Outbreaks and emerging infections (166), Policy, surveillance, and public health infrastructure (12), Occupational and environmental epidemiology (8)
...
- Newly tracked story cluster: 49 item(s) across 42 source(s).
- Baseline snapshot created with 49 clustered item(s) across 42 source(s).
...
## Major topics
### Ebola virus disease
- Topic size: 123 item(s) across 87 source(s); 5 official/primary-source item(s).
...
### Measles transmission and vaccination
- Topic size: 49 item(s) across 42 source(s); 2 official/primary-source item(s).
