...
- Category mix: Outbreaks and emerging infections (126), Policy, surveillance, and public health infrastructure (13), Occupational and environmental epidemiology (8)
...
## Major topics
### Ebola virus disease
- Topic size: 130 item(s) across 94 source(s); 4 official/primary-source item(s).
