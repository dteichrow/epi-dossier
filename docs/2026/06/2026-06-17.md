...
- Category mix: Outbreaks and emerging infections (148), Policy, surveillance, and public health infrastructure (9), Occupational and environmental epidemiology (8)
...
## Major topics
### Ebola virus disease
- Topic size: 121 item(s) across 84 source(s); 5 official/primary-source item(s).
