...
- Category mix: Outbreaks and emerging infections (111), Occupational and environmental epidemiology (7), Major epidemiology studies (5)
...
## Major topics
### Ebola virus disease
- Topic size: 106 item(s) across 79 source(s); 3 official/primary-source item(s).
