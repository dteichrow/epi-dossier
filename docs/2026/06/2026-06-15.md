...
- Category mix: Outbreaks and emerging infections (105), Policy, surveillance, and public health infrastructure (7), Occupational and environmental epidemiology (7)
...
## Major topics
### Ebola virus disease
- Topic size: 101 item(s) across 78 source(s); 3 official/primary-source item(s).
