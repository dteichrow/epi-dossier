...
- Category mix: Outbreaks and emerging infections (164), Policy, surveillance, and public health infrastructure (26), Major epidemiology studies (4)
...
- New publisher/source coverage joined this story cluster: A News, Arabian Business, Avian Flu Diary.
...
- New publisher/source coverage joined this story cluster: The island.lk.
- The lead item has changed to [Dengue risk zones identified in Kandy District as cases rise](http://island.lk/dengue-risk-zones-identified-in-kandy-district-as-cases-rise/) from The island.lk.
- 2 newly observed linked item(s) were added since the last saved snapshot.
...
- New publisher/source coverage joined this story cluster: Australian Broadcasting Corporation.
- The lead item has changed to [H5N1 emerged in Asia 30 years ago. Here's what happened next](https://www.abc.net.au/news/2026-06-26/asia-response-to-h5n1-variant-bird-flu/106839290) from Australian Broadcasting Corporation.
...
- New publisher/source coverage joined this story cluster: The New Daily, The Peninsula Qatar, Türkiye Today.
- 2 newly observed linked item(s) were added since the last saved snapshot.


## Major topics
### Ebola virus disease
- Topic size: 130 item(s) across 90 source(s); 4 official/primary-source item(s).
