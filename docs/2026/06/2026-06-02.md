...
- Category mix: Outbreaks and emerging infections (198), Policy, surveillance, and public health infrastructure (32), Major epidemiology studies (3)
...
## Major topics
### Ebola virus disease
- Topic size: 220 item(s) across 121 source(s); 5 official/primary-source item(s).
