...
- Newly tracked story cluster: 233 item(s) across 114 source(s).
- Baseline snapshot created with 233 clustered item(s) across 114 source(s).
...
## Major topics
### Ebola virus disease
- Topic size: 233 item(s) across 114 source(s); 5 official/primary-source item(s).
