...
- Newly tracked story cluster: 229 item(s) across 127 source(s).
- Baseline snapshot created with 229 clustered item(s) across 127 source(s).
...
## Major topics
### Ebola virus disease
- Topic size: 229 item(s) across 127 source(s); 5 official/primary-source item(s).
