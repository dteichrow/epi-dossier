...
- Newly tracked story cluster: 232 item(s) across 115 source(s).
- Baseline snapshot created with 232 clustered item(s) across 115 source(s).
...
## Major topics
### Ebola virus disease
- Topic size: 232 item(s) across 115 source(s); 5 official/primary-source item(s).
