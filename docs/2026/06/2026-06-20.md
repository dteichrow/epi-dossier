...
- Category mix: Outbreaks and emerging infections (149), Policy, surveillance, and public health infrastructure (19), Historical epidemiology / ancient disease / paleopathology (2)
...
- Newly tracked story cluster: 130 item(s) across 105 source(s).
- Baseline snapshot created with 130 clustered item(s) across 105 source(s).
...
## Major topics
### Ebola virus disease
- Topic size: 130 item(s) across 105 source(s); 4 official/primary-source item(s).
...
### Measles transmission and vaccination
- Topic size: 21 item(s) across 18 source(s); 3 official/primary-source item(s).
