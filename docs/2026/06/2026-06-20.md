...
- Category mix: Outbreaks and emerging infections (143), Policy, surveillance, and public health infrastructure (18), Historical epidemiology / ancient disease / paleopathology (2)
...
### Measles transmission and vaccination
- Topic size: 22 item(s) across 20 source(s); 3 official/primary-source item(s).
