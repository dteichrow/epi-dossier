...
- Category mix: Outbreaks and emerging infections (162), Policy, surveillance, and public health infrastructure (17), Historical epidemiology / ancient disease / paleopathology (2)
...
- Newly tracked story cluster: 145 item(s) across 117 source(s).
- Baseline snapshot created with 145 clustered item(s) across 117 source(s).
...
## Major topics
### Ebola virus disease
- Topic size: 145 item(s) across 117 source(s); 4 official/primary-source item(s).
