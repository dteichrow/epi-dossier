...
- Newly tracked story cluster: 237 item(s) across 140 source(s).
- Baseline snapshot created with 237 clustered item(s) across 140 source(s).
...
## Major topics
### Ebola virus disease
- Topic size: 237 item(s) across 140 source(s); 5 official/primary-source item(s).
