...
- Category mix: Outbreaks and emerging infections (195), Policy, surveillance, and public health infrastructure (18), Major epidemiology studies (3)
...
## Major topics
### Ebola virus disease
- Topic size: 199 item(s) across 123 source(s); 4 official/primary-source item(s).
