...
- Newly tracked story cluster: 217 item(s) across 121 source(s).
- Baseline snapshot created with 217 clustered item(s) across 121 source(s).
...
## Major topics
### Ebola virus disease
- Topic size: 217 item(s) across 121 source(s); 4 official/primary-source item(s).
