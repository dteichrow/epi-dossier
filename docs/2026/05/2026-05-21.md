...
- Category mix: Outbreaks and emerging infections (227), Policy, surveillance, and public health infrastructure (28), Major epidemiology studies (3)
...
- New publisher/source coverage joined this story cluster: Bhaskar English, Bloomberg.com, Cleveland 19 News.
- Story volume increased from 233 to 242 clustered item(s) in the current window.
- 1 newly observed linked item(s) were added since the last saved snapshot.


## Major topics
### Ebola virus disease
- Topic size: 242 item(s) across 147 source(s); 7 official/primary-source item(s).
