...
- Category mix: Outbreaks and emerging infections (236), Policy, surveillance, and public health infrastructure (25), Major epidemiology studies (4)
...
## Major topics
### Ebola virus disease
- Topic size: 230 item(s) across 134 source(s); 4 official/primary-source item(s).
