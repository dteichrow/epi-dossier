...
- Category mix: Outbreaks and emerging infections (241), Policy, surveillance, and public health infrastructure (18), Major epidemiology studies (4)
...
## Major topics
### Ebola virus disease
- Topic size: 230 item(s) across 136 source(s); 4 official/primary-source item(s).
