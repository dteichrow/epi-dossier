...
- Newly tracked story cluster: 239 item(s) across 138 source(s).
- Baseline snapshot created with 239 clustered item(s) across 138 source(s).
...
## Major topics
### Ebola virus disease
- Topic size: 239 item(s) across 138 source(s); 6 official/primary-source item(s).
