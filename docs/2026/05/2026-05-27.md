...
- Category mix: Outbreaks and emerging infections (267), Policy, surveillance, and public health infrastructure (28)
...
- Newly tracked story cluster: 263 item(s) across 159 source(s).
- Baseline snapshot created with 263 clustered item(s) across 159 source(s).
...
## Major topics
### Ebola virus disease
- Topic size: 263 item(s) across 159 source(s); 6 official/primary-source item(s).
