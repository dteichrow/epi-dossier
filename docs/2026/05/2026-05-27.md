...
- Category mix: Outbreaks and emerging infections (253), Policy, surveillance, and public health infrastructure (24)
...
- Newly tracked story cluster: 251 item(s) across 148 source(s).
- Baseline snapshot created with 251 clustered item(s) across 148 source(s).
...
## Major topics
### Ebola virus disease
- Topic size: 251 item(s) across 148 source(s); 6 official/primary-source item(s).
