...
- Category mix: Outbreaks and emerging infections (234), Policy, surveillance, and public health infrastructure (26)
...
- Newly tracked story cluster: 228 item(s) across 147 source(s).
- Baseline snapshot created with 228 clustered item(s) across 147 source(s).
...
## Major topics
### Ebola virus disease
- Topic size: 228 item(s) across 147 source(s); 6 official/primary-source item(s).
...
- [US to set up Ebola quarantine facility in Kenya](https://www.theeastafrican.co.ke/tea/news/east-africa/us-to-set-up-ebola-quarantine-facility-in-kenya--5475150) | The EastAfrican | 2026-05-27T08:57+00:00 | Outbreaks and emerging infections
  Limited detail was available from feed metadata alone.
