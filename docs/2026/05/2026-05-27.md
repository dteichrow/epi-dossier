...
- Category mix: Outbreaks and emerging infections (268), Policy, surveillance, and public health infrastructure (27)
...
- Newly tracked story cluster: 264 item(s) across 156 source(s).
- Baseline snapshot created with 264 clustered item(s) across 156 source(s).
...
## Major topics
### Ebola virus disease
- Topic size: 264 item(s) across 156 source(s); 6 official/primary-source item(s).
