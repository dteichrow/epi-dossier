...
- Category mix: Outbreaks and emerging infections (241), Policy, surveillance, and public health infrastructure (26), Major epidemiology studies (1)
...
## Major topics
### Ebola virus disease
- Topic size: 239 item(s) across 139 source(s); 6 official/primary-source item(s).
