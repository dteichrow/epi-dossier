...
- Category mix: Outbreaks and emerging infections (262), Policy, surveillance, and public health infrastructure (25)
...
- Newly tracked story cluster: 256 item(s) across 158 source(s).
- Baseline snapshot created with 256 clustered item(s) across 158 source(s).
...
## Major topics
### Ebola virus disease
- Topic size: 256 item(s) across 158 source(s); 6 official/primary-source item(s).
