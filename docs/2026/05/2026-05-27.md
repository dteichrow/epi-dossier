...
- Category mix: Outbreaks and emerging infections (259), Policy, surveillance, and public health infrastructure (28)
...
- Newly tracked story cluster: 259 item(s) across 152 source(s).
- Baseline snapshot created with 259 clustered item(s) across 152 source(s).
...
## Major topics
### Ebola virus disease
- Topic size: 259 item(s) across 152 source(s); 6 official/primary-source item(s).
