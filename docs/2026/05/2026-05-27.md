...
- Newly tracked story cluster: 247 item(s) across 141 source(s).
- Baseline snapshot created with 247 clustered item(s) across 141 source(s).
...
## Major topics
### Ebola virus disease
- Topic size: 247 item(s) across 141 source(s); 6 official/primary-source item(s).
