...
- Newly tracked story cluster: 265 item(s) across 161 source(s).
- Baseline snapshot created with 265 clustered item(s) across 161 source(s).
...
## Major topics
### Ebola virus disease
- Topic size: 265 item(s) across 161 source(s); 6 official/primary-source item(s).
