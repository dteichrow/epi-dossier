...
- Category mix: Outbreaks and emerging infections (240), Policy, surveillance, and public health infrastructure (26), Major epidemiology studies (1)
...
- Newly tracked story cluster: 238 item(s) across 144 source(s).
- Baseline snapshot created with 238 clustered item(s) across 144 source(s).
...
## Major topics
### Ebola virus disease
- Topic size: 238 item(s) across 144 source(s); 5 official/primary-source item(s).
