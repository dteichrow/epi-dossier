...
- Category mix: Outbreaks and emerging infections (249), Policy, surveillance, and public health infrastructure (22), Occupational and environmental epidemiology (3)
...
- Newly tracked story cluster: 239 item(s) across 146 source(s).
- Baseline snapshot created with 239 clustered item(s) across 146 source(s).
...
## Major topics
### Ebola virus disease
- Topic size: 239 item(s) across 146 source(s); 5 official/primary-source item(s).
