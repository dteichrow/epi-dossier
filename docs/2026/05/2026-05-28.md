...
- Newly tracked story cluster: 231 item(s) across 140 source(s).
- Baseline snapshot created with 231 clustered item(s) across 140 source(s).
...
## Major topics
### Ebola virus disease
- Topic size: 231 item(s) across 140 source(s); 5 official/primary-source item(s).
