...
- Newly tracked story cluster: 250 item(s) across 153 source(s).
- Baseline snapshot created with 250 clustered item(s) across 153 source(s).
...
## Major topics
### Ebola virus disease
- Topic size: 250 item(s) across 153 source(s); 5 official/primary-source item(s).
