...
- Category mix: Outbreaks and emerging infections (251), Policy, surveillance, and public health infrastructure (25), Major epidemiology studies (3)
...
- Newly tracked story cluster: 243 item(s) across 146 source(s).
- Baseline snapshot created with 243 clustered item(s) across 146 source(s).
...
## Major topics
### Ebola virus disease
- Topic size: 243 item(s) across 146 source(s); 5 official/primary-source item(s).
