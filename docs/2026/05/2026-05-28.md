...
- Category mix: Outbreaks and emerging infections (233), Policy, surveillance, and public health infrastructure (26), Major epidemiology studies (1)
...
- Newly tracked story cluster: 231 item(s) across 141 source(s).
- Baseline snapshot created with 231 clustered item(s) across 141 source(s).
...
## Major topics
### Ebola virus disease
- Topic size: 231 item(s) across 141 source(s); 5 official/primary-source item(s).
