...
- Newly tracked story cluster: 241 item(s) across 146 source(s).
- Baseline snapshot created with 241 clustered item(s) across 146 source(s).
...
## Major topics
### Ebola virus disease
- Topic size: 241 item(s) across 146 source(s); 5 official/primary-source item(s).
