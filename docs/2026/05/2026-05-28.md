...
- Newly tracked story cluster: 243 item(s) across 151 source(s).
- Baseline snapshot created with 243 clustered item(s) across 151 source(s).
...
## Major topics
### Ebola virus disease
- Topic size: 243 item(s) across 151 source(s); 5 official/primary-source item(s).
