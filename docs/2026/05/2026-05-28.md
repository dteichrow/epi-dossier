...
- Category mix: Outbreaks and emerging infections (232), Policy, surveillance, and public health infrastructure (21), Occupational and environmental epidemiology (3)
...
## Major topics
### Ebola virus disease
- Topic size: 224 item(s) across 129 source(s); 5 official/primary-source item(s).
