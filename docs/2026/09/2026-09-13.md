...
- Category mix: Outbreaks and emerging infections (213), Policy, surveillance, and public health infrastructure (22), Occupational and environmental epidemiology (14)
...
## Major topics
### Measles transmission and vaccination
- Topic size: 96 item(s) across 81 source(s); 2 official/primary-source item(s).
...
### Ebola virus disease
- Topic size: 58 item(s) across 51 source(s); 2 official/primary-source item(s).
