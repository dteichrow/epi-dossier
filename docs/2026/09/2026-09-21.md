...
- Category mix: Outbreaks and emerging infections (214), Policy, surveillance, and public health infrastructure (32), Occupational and environmental epidemiology (12)
...
## Major topics
### Measles transmission and vaccination
- Topic size: 115 item(s) across 84 source(s); 1 official/primary-source item(s).
...
### Ebola virus disease
- Topic size: 65 item(s) across 52 source(s); 4 official/primary-source item(s).
