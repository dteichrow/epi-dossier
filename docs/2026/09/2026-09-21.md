...
- Category mix: Outbreaks and emerging infections (211), Policy, surveillance, and public health infrastructure (31), Occupational and environmental epidemiology (12)
...
- Newly tracked story cluster: 42 item(s) across 33 source(s).
...
### Dengue and arboviruses
- Topic size: 42 item(s) across 33 source(s); 1 official/primary-source item(s).
