...
- Category mix: Outbreaks and emerging infections (202), Policy, surveillance, and public health infrastructure (28), Occupational and environmental epidemiology (13)
...
- Newly tracked story cluster: 56 item(s) across 50 source(s).
...
- Detailed note: states in measles cases and hospitalizations Pittsburgh Post-Gazette Learn more about the Sunset process and provide feedback.
...
### Ebola virus disease
- Topic size: 56 item(s) across 50 source(s); 2 official/primary-source item(s).
