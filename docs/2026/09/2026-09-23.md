...
- Category mix: Outbreaks and emerging infections (216), Policy, surveillance, and public health infrastructure (21), Historical epidemiology / ancient disease / paleopathology (5)
...
### Ebola virus disease
- Topic size: 71 item(s) across 56 source(s); 5 official/primary-source item(s).
