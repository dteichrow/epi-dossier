...
- Category mix: Outbreaks and emerging infections (205), Policy, surveillance, and public health infrastructure (23), Historical epidemiology / ancient disease / paleopathology (5)
...
- Newly tracked story cluster: 109 item(s) across 92 source(s).
...
## Major topics
### Measles transmission and vaccination
- Topic size: 109 item(s) across 92 source(s); 1 official/primary-source item(s).
