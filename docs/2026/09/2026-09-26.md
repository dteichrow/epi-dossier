...
- Category mix: Outbreaks and emerging infections (210), Policy, surveillance, and public health infrastructure (23), Occupational and environmental epidemiology (7)
...
- Newly tracked story cluster: 40 item(s) across 29 source(s).
...
## Major topics
### Measles transmission and vaccination
- Topic size: 113 item(s) across 86 source(s); 1 official/primary-source item(s).
...
### Ebola virus disease
- Topic size: 61 item(s) across 48 source(s); 4 official/primary-source item(s).
