...
- Category mix: Outbreaks and emerging infections (212), Policy, surveillance, and public health infrastructure (22), Historical epidemiology / ancient disease / paleopathology (4)
...
### Ebola virus disease
- Topic size: 65 item(s) across 55 source(s); 5 official/primary-source item(s).
