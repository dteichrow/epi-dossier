...
- Source health: 3 source(s) failed during collection: Africa CDC, Nigeria Centre for Disease Control, bioRxiv Infectious Disease.
...
## Major topics
### Cyclosporiasis
- Topic size: 110 item(s) across 85 source(s); 1 official/primary-source item(s).
