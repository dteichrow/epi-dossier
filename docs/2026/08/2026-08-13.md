...
- Category mix: Outbreaks and emerging infections (250), Policy, surveillance, and public health infrastructure (28), Historical epidemiology / ancient disease / paleopathology (6)
...
- Newly tracked story cluster: 82 item(s) across 64 source(s).
- Baseline snapshot created with 82 clustered item(s) across 64 source(s).
- PubMed Infectious Disease Search now foregrounds vaccination or vaccine policy in the story.
...
### Measles transmission and vaccination
- Topic size: 82 item(s) across 64 source(s); 3 official/primary-source item(s).
