...
- Category mix: Outbreaks and emerging infections (272), Policy, surveillance, and public health infrastructure (38), Historical epidemiology / ancient disease / paleopathology (5)
...
- Newly tracked story cluster: 69 item(s) across 63 source(s).
- Baseline snapshot created with 69 clustered item(s) across 63 source(s).
...
### Measles transmission and vaccination
- Topic size: 69 item(s) across 63 source(s); 1 official/primary-source item(s).
