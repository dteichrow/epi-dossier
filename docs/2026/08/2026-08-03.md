...
- Category mix: Outbreaks and emerging infections (292), Policy, surveillance, and public health infrastructure (35), Major epidemiology studies (7)
...
- Newly tracked story cluster: 129 item(s) across 81 source(s).
- Baseline snapshot created with 129 clustered item(s) across 81 source(s).
...
## Major topics
### Cyclosporiasis
- Topic size: 129 item(s) across 81 source(s); 4 official/primary-source item(s).
