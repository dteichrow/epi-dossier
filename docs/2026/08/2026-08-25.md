...
- Category mix: Outbreaks and emerging infections (301), Policy, surveillance, and public health infrastructure (15), Major epidemiology studies (3)
...
- Newly tracked story cluster: 143 item(s) across 121 source(s).
- Baseline snapshot created with 143 clustered item(s) across 121 source(s).
...
## Major topics
### Measles transmission and vaccination
- Topic size: 143 item(s) across 121 source(s); 3 official/primary-source item(s).
