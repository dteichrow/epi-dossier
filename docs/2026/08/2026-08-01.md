...
- Category mix: Outbreaks and emerging infections (301), Policy, surveillance, and public health infrastructure (41), Major epidemiology studies (7)
...
## Major topics
### Cyclosporiasis
- Topic size: 153 item(s) across 94 source(s); 4 official/primary-source item(s).
...
### Ebola virus disease
- Topic size: 109 item(s) across 71 source(s); 3 official/primary-source item(s).
