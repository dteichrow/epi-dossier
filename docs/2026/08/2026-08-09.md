...
- Category mix: Outbreaks and emerging infections (254), Policy, surveillance, and public health infrastructure (26), Virology and pathogen evolution (5)
...
### Ebola virus disease
- Topic size: 80 item(s) across 55 source(s); 1 official/primary-source item(s).
