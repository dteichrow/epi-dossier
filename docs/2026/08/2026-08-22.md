...
- Category mix: Outbreaks and emerging infections (301), Policy, surveillance, and public health infrastructure (17), Occupational and environmental epidemiology (2)
...
- Newly tracked story cluster: 60 item(s) across 44 source(s).
- Baseline snapshot created with 60 clustered item(s) across 44 source(s).
...
### Cyclosporiasis
- Topic size: 60 item(s) across 44 source(s); 1 official/primary-source item(s).
