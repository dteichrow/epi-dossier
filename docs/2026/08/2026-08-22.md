...
- Category mix: Outbreaks and emerging infections (299), Policy, surveillance, and public health infrastructure (17), Historical epidemiology / ancient disease / paleopathology (2)
...
- Newly tracked story cluster: 64 item(s) across 45 source(s).
- Baseline snapshot created with 64 clustered item(s) across 45 source(s).
