...
- Category mix: Outbreaks and emerging infections (292), Policy, surveillance, and public health infrastructure (25), Occupational and environmental epidemiology (4)
...
## Major topics
### Ebola virus disease
- Topic size: 124 item(s) across 84 source(s); 2 official/primary-source item(s).
...
### Cyclosporiasis
- Topic size: 69 item(s) across 52 source(s); 3 official/primary-source item(s).
